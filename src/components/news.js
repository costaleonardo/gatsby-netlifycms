      ...
      <div className="row">
        <div className="col-lg-4 col-md-6 col-12">
          ...
          <div className="single-news">
            <div className="image">
              <a href="/"><img className="thumb" src="assets/images/blog/1.jpg" alt="Blog" /></a>
        ...
        <div className="col-lg-4 col-md-6 col-12">
          ...
          <div className="single-news">
            <div className="image">
              <a href="/"><img className="thumb" src="assets/images/blog/2.jpg" alt="Blog" /></a>
              <div className="meta-details">
                <img className="thumb" src="assets/images/blog/b6.jpg" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
        ...
        <div className="col-lg-4 col-md-6 col-12">
          ...
          <div className="single-news">
            <div className="image">
              <a href="/"><img className="thumb" src="assets/images/blog/3.jpg" alt="Blog" /></a>
              <div className="meta-details">
                <img className="thumb" src="assets/images/blog/b6.jpg" alt="Author" />
                <span>BY TIM NORTON</span>
              </div>
